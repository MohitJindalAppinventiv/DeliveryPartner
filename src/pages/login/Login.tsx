...
import {
  loginschema,
  type LoginFormData,
} from "../../validations/loginValidation"; // Assuming you have the zod schema defined elsewhere
...
const Login: React.FC = () => {
  ...
  ); // Access status and error from the store
  ...
  return (
    <motion.div
      ...
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-200 font-sans"
    >
